...
parser.add_argument('--video', type=str, default="data_video/MOT17_13.avi", help='video file name')
...
parser.add_argument('--gmc', type=str, default='gmc/mot17/GMC-MOT17-13.txt')
parser.add_argument('--det_result', type=str, default='det_results/mot17/yolox_x_ablation/MOT17-13-SDP.txt', help='video result text file ')
parser.add_argument('--output_video', type=str, default='output/topview_MOT17_13_lookup_table.avi', help='result video file name')
parser.add_argument('--cam_para', type=str, default="cam_para/MOT17/MOT17-13-SDP.txt", help='camera parameter file name')
