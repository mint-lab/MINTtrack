...
# for i in "${sequence_numbers[@]}"
# do
#     python demo.py --video "data_video/MOT17_${i}.avi" --gmc "gmc/mot17/GMC-MOT17-${i}.txt" --det_result "det_results/mot17/yolox_x_ablation/MOT17-${i}-SDP.txt" --use_cmc 1 --output_video "output/MOT17_${i}_output.avi" --cam_para "cam_para/MOT17/MOT17-${i}-SDP.txt"
# done
