import numpy as np
import cv2 as cv
from detector.object_track import check_polygons
...
def test_localize(image_file, config_file, camera_name='camera', show_uncertainty=True):
...
if __name__ == '__main__':
    # Test object localization with `data/ETRITestbed`
    # test_localize('data/ETRITestbed/camera4_210812.png',  'config_etri_testbed_2022.json', camera_name='camera4')
    # test_localize('data/ETRITestbed/camera5_210812.png',  'config_etri_testbed_2022.json', camera_name='camera5')
    # test_localize('data/ETRITestbed/camera6_210812.png',  'config_etri_testbed_2022.json', camera_name='camera6')
    # test_localize('data/ETRITestbed/camera7_210812.png',  'config_etri_testbed_2022.json', camera_name='camera7')

    # Test object localization with `data/ETRITestbed2`
    test_localize('data/ETRITestbed2/camera01_230927.png', 'config_etri_testbed_2023.json', camera_name='camera01')
    # test_localize('data/ETRITestbed2/camera02_230927.png', 'config_etri_testbed_2023.json', camera_name='camera02')
    # test_localize('data/ETRITestbed2/camera03_230927.png', 'config_etri_testbed_2023.json', camera_name='camera03')
    # test_localize('data/ETRITestbed2/camera04_230927.png', 'config_etri_testbed_2023.json', camera_name='camera04')
    # test_localize('data/ETRITestbed2/camera05_230927.png', 'config_etri_testbed_2023.json', camera_name='camera05')
    # test_localize('data/ETRITestbed2/camera06_231110.png', 'config_etri_testbed_2023.json', camera_name='camera06')
    # test_localize('data/ETRITestbed2/camera07_230927.png', 'config_etri_testbed_2023.json', camera_name='camera07')
    # test_localize('data/ETRITestbed2/camera10_230927.png', 'config_etri_testbed_2023.json', camera_name='camera10')

    # Test object localization with `data/MiraeHall` and `data/ETRIParking`
    # test_localize('data/MiraeHall/220722_video.png',      'config_mirae_hall_video.json')
    # test_localize('data/MiraeHall/220722_undistort.png',  'config_mirae_hall_undistort.json')
    # test_localize('data/ETRIParking/221215_way.png',      'config_etri_parking.json')